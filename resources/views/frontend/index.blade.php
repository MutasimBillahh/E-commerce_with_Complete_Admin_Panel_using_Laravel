...
@endforeach {{-- end Special Offer Foreach ENd --}}
...
@foreach($special_deals as $product)
    ...
    @endforeach {{-- End Special DEALS Foreach ENd --}}
...
@endif
  ...
  <!-- /.item -->
            @endforeach {{-- End Products Foreasch --}}
...
$carwiseProduct = App\Models\Product::where('category_id',$category->id)->orderBy('id', 'DESC')->get();

@endphp

@forelse($carwiseProduct as $product)
...
@empty
  <h5 class="text-danger">NO PRODUCT FOUND</h5>
            @endforelse {{-- End Products Foreasch --}}
       ...
       @endforeach {{-- end categories Foreach --}}
...
@if(session()->get('language') == 'hindi') {{ $product->product_name_hin }} @else {{ $product->product_name_en }} @endif
 ...
 <div class="product-price"> <span class="price"> ${{ $product->discount_price }} </span> <span class="price-before-discount">$ {{ $product->selling_price }}</span> </div>
  ...
  <!-- == === skip_Brand 2 Started == ==== -->

        <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
@if(session()->get('language') == 'hindi') {{ $skip_brand_2->brand_name_hin }} @else {{ $skip_brand_2->brand_name_en }} @endif
            </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
