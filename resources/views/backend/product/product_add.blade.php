...
<div class="form-group">
								...
								<div class="controls">
									<input type="text" name="product_tags_en" class="form-control" value="Jacket, T-Shirt, Shoe" data-role="tagsinput" required>
...
<div class="row"> {{-- Start 4th row --}}
	...
	<div class="form-group">
								...
								<div class="controls">
									<input type="text" name="product_tags_hin" class="form-control" value="Jacket, T-Shirt, Shoe" data-role="tagsinput" required>
...
<div class="row"> {{-- Start 5th row --}}
	...
	<div class="form-group">
								...
								<div class="controls">
									<input type="text" name="product_color_en" class="form-control" value="Red,White" data-role="tagsinput" required>
...
<div class="col-md-4">
				...
				<div class="form-group">
								...
								<div class="controls">
									<input type="text" name="product_color_hin" class="form-control" value="Red,White" data-role="tagsinput" required>
