...
<div class="form-group">
	...
	<div class="controls">
		...
		<input type="text" name="product_color_en" class="form-control" value="Red,White" data-role="tagsinput" required value="{{$products->product_color_en}}">
...
<input type="text" name="product_color_hin" class="form-control" value="Red,White" data-role="tagsinput" required value="{{$products->product_color_hin}}">
